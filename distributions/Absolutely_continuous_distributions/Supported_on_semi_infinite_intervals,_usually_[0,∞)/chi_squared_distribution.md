...
| Notation | χ 2 ( k ) {\displaystyle \chi ^{2}(k)\;} or χ k 2 {\displaystyle \chi _{k}^{2}\!} ${\displaystyle \chi ^{2}(k)\;}$ ${\displaystyle \chi _{k}^{2}\!}$ |
| Parameters | k ∈ N ∗ {\displaystyle k\in \mathbb {N} ^{*}~~} (known as "degrees of freedom") ${\displaystyle k\in \mathbb {N} ^{*}~~}$ |
| Support | x ∈ ( 0 , + ∞ ) {\displaystyle x\in (0,+\infty )\;} ${\displaystyle x\in (0,+\infty )\;}$ |
| PDF | 1 2 k / 2 Γ ( k / 2 ) x ( k / 2 ) − 1 e − x / 2 {\displaystyle {\frac {1}{2^{k/2}\Gamma (k/2)}}\;x^{(k/2)-1}e^{-x/2}\;} ${\displaystyle {\frac {1}{2^{k/2}\Gamma (k/2)}}\;x^{(k/2)-1}e^{-x/2}\;}$ |
| CDF | 1 Γ ( k / 2 ) γ ( k 2 , x 2 ) {\displaystyle {\frac {1}{\Gamma (k/2)}}\;\gamma {\left({\frac {k}{2}},\,{\frac {x}{2}}\right)}\;} ${\displaystyle {\frac {1}{\Gamma (k/2)}}\;\gamma {\left({\frac {k}{2}},\,{\frac {x}{2}}\right)}\;}$ |
| Mean | k {\displaystyle k} ${\displaystyle k}$ |
| Median | ≈ k ( 1 − 2 9 k ) 3 {\displaystyle \approx k{\bigg (}1-{\frac {2}{9k}}{\bigg )}^{3}\;} ${\displaystyle \approx k{\bigg (}1-{\frac {2}{9k}}{\bigg )}^{3}\;}$ |
| Mode | max ( k − 2 , 0 ) {\displaystyle \max(k-2,0)\;} ${\displaystyle \max(k-2,0)\;}$ |
| Variance | 2 k {\displaystyle 2k\;} ${\displaystyle 2k\;}$ |
| Skewness | 8 / k {\textstyle {\sqrt {8/k}}\,} ${\textstyle {\sqrt {8/k}}\,}$ |
| Excess kurtosis | 12 k {\displaystyle {\frac {12}{k}}} ${\displaystyle {\frac {12}{k}}}$ |
| Entropy | k 2 + log ⁡ ( 2 Γ ( k 2 ) ) + ( 1 − k 2 ) ψ ( k 2 ) {\displaystyle {\begin{aligned}{\frac {k}{2}}&+\log \left(2\Gamma {\left({\frac {k}{2}}\right)}\right)\\&\!+\left(1-{\frac {k}{2}}\right)\psi {\left({\frac {k}{2}}\right)}\end{aligned}}} ${\displaystyle {\begin{aligned}{\frac {k}{2}}&+\log \left(2\Gamma {\left({\frac {k}{2}}\right)}\right)\\&\!+\left(1-{\frac {k}{2}}\right)\psi {\left({\frac {k}{2}}\right)}\end{aligned}}}$ |
| MGF | ( 1 − 2 t ) − k / 2 {\displaystyle (1-2t)^{-k/2}} for t < 1 2 {\displaystyle t<{\tfrac {1}{2}}\;} ${\displaystyle (1-2t)^{-k/2}}$ ${\displaystyle t<{\tfrac {1}{2}}\;}$ |
| CF | ( 1 − 2 i t ) − k / 2 {\displaystyle (1-2it)^{-k/2}} [1] ${\displaystyle (1-2it)^{-k/2}}$ |
| PGF | ( 1 − 2 ln ⁡ t ) − k / 2 {\displaystyle (1-2\ln t)^{-k/2}} for 0 < t < e {\displaystyle 0<t<{\sqrt {e}}\;} ${\displaystyle (1-2\ln t)^{-k/2}}$ ${\displaystyle 0<t<{\sqrt {e}}\;}$ |
...
{\displaystyle k}
 ...
 independent standard normal random variables.[2] ${\displaystyle \chi ^{2}}$ ${\displaystyle k}$ ${\displaystyle k}$
...
{\textstyle X\sim {\text{Gamma}}(\alpha ={\frac {k}{2}},\theta =2)}
...
. ${\displaystyle \chi _{k}^{2}}$ ${\displaystyle X\sim \chi _{k}^{2}}$ ${\textstyle X\sim {\text{Gamma}}(\alpha ={\frac {k}{2}},\theta =2)}$ ${\displaystyle \alpha }$ ${\displaystyle \theta }$ ${\displaystyle X\sim {\text{W}}_{1}(1,k)}$
...
{\textstyle X\sim {\text{Gamma}}(\alpha ={\frac {k}{2}},\theta =2s^{2})}
{\displaystyle X\sim {\text{W}}_{1}(s^{2},k)}

. ${\displaystyle s^{2}\chi _{k}^{2}}$ ${\displaystyle X\sim s^{2}\chi _{k}^{2}}$ ${\textstyle X\sim {\text{Gamma}}(\alpha ={\frac {k}{2}},\theta =2s^{2})}$ ${\displaystyle X\sim {\text{W}}_{1}(s^{2},k)}$
...
{\displaystyle X\ \sim \ \chi ^{2}(k)\ \ {\text{or}}\ \ X\ \sim \ \chi _{k}^{2}.}
...
{\displaystyle \chi ^{2}={\frac {\left(m-Np\right)^{2}}{Npq}}}
...
{\displaystyle \chi ^{2}={\frac {\left(m-Np\right)^{2}}{Np}}+{\frac {\left(N-m-Nq\right)^{2}}{Nq}}}

The expression on the right is of the form that Karl Pearson would generalize to the form
{\displaystyle \chi ^{2}=\sum _{i=1}^{n}{\frac {\left(O_{i}-E_{i}\right)^{2}}{E_{i}}}}
...
{\displaystyle n}
 ...
 = the number of cells in the table.[citation needed]
...
{\textstyle \Gamma (k/2)}
 ...
 denotes the gamma function, which has closed-form values for integer 
...
{\displaystyle k}
 ...
 degrees of freedom, see Proofs related to chi-squared distribution.
...
{\displaystyle F(x;\,k)={\frac {\gamma {\left({\frac {k}{2}},\,{\frac {x}{2}}\right)}}{\Gamma {\left({\frac {k}{2}}\right)}}}=P{\left({\frac {k}{2}},\,{\frac {x}{2}}\right)},}
...
, Chernoff bounds on the lower and upper tails of the CDF may be obtained.[11] For the cases when 
{\displaystyle 0<z<1}
...
Properties[edit]
Cochran's theorem[edit]
Main article: Cochran's theorem
The following is a special case of Cochran's theorem.
Theorem. If 
{\displaystyle Z_{1},...,Z_{n}}

 are independent identically distributed (i.i.d.), standard normal random variables, then
...
{\textstyle \sum _{t=1}^{n}\left(Z_{t}-{\bar {Z}}\right)^{2}\sim \chi _{n-1}^{2}}
...
{\textstyle {\bar {Z}}={\frac {1}{n}}\sum _{t=1}^{n}Z_{t}.}
...
where 
{\displaystyle {\overline {X}}={\frac {1}{n}}\sum _{i=1}^{n}X_{i}\sim \operatorname {Gamma} \left(\alpha {=}{\tfrac {nk}{2}},\,\theta {=}{\tfrac {2}{n}}\right)\qquad {\text{where }}X_{i}\sim \chi ^{2}(k)}

Asymptotically, given that for a shape parameter 
...
{\displaystyle {\overline {X}}\xrightarrow {n\to \infty } N{\left(\mu {=}k,\,\sigma ^{2}{=}{\tfrac {2k}{n}}\right)}}
...
{\textstyle \sigma ^{2}={\tfrac {2k}{n}}}

).

Entropy[edit]
The differential entropy is given by
{\displaystyle {\begin{aligned}h&=\int _{0}^{\infty }f(x;\,k)\ln f(x;\,k)\,dx\\&={\frac {k}{2}}+\ln \left[2\,\Gamma {\left({\frac {k}{2}}\right)}\right]+\left(1-{\frac {k}{2}}\right)\psi \!\left({\frac {k}{2}}\right),\end{aligned}}}
...
{\displaystyle k}
 ...
 degrees of freedom are given by[12][13]
{\displaystyle {\begin{aligned}\operatorname {E} (X^{m})&=k(k+2)(k+4)\cdots (k+2m-2)\\[1ex]&=2^{m}{\frac {\Gamma {\left(m+{\frac {k}{2}}\right)}}{\Gamma {\left({\frac {k}{2}}\right)}}}.\end{aligned}}}
...
{\displaystyle k}
 ...
 with a width 
{\displaystyle k^{1/2+\alpha }}
{\displaystyle \Pr \left(\left\|Z\right\|^{2}\in \left[k-2k^{1/2+\alpha },\;k+2k^{1/2+\alpha }+2k^{\alpha }\right]\right)\geq 1-e^{-k^{\alpha }}}
...
.
Since the cumulant generating function for 
...
{\textstyle K(t)=-{\frac {k}{2}}\ln(1-2t)}

, and its convex dual is 
...
{\textstyle K^{*}(q)={\frac {1}{2}}\left(q-k+k\ln {\frac {k}{q}}\right)}

, the standard Chernoff bound yields
{\displaystyle {\begin{aligned}\ln \Pr(X\geq (1+\varepsilon )k)&\leq -{\frac {k}{2}}\left(\varepsilon -\ln(1+\varepsilon )\right)\\\ln \Pr(X\leq (1-\varepsilon )k)&\leq -{\frac {k}{2}}\left(-\varepsilon -\ln(1-\varepsilon )\right)\end{aligned}}}

where 
{\displaystyle 0<\varepsilon <1}

. By the union bound,
{\displaystyle Pr(X\in (1\pm \varepsilon )k)\geq 1-2e^{-{\frac {k}{2}}({\frac {1}{2}}\varepsilon ^{2}-{\frac {1}{3}}\varepsilon ^{3})}}

This result is used in proving the Johnson–Lindenstrauss lemma.[15]
...
{\displaystyle k>50}
 ...
 the distribution is sufficiently close to a normal distribution, so the difference is ignorable.[16] Specifically, if 
...
,[17] as the logarithmic transform removes much of the asymmetry.[18]
...
{\displaystyle {\sqrt {2k-1}}}
 ...
 and unit variance (1922, by R. A. Fisher, see (18.23), p. 426 of Johnson).[5]
{\displaystyle X\sim \chi ^{2}(k)}
...
[19] This is known as the Wilson–Hilferty transformation, see (18.24), p. 426 of Johnson.[5]
This normalizing transformation leads directly to the commonly used median approximation 
...
{\displaystyle \left\|{\boldsymbol {N}}_{i=1,\ldots ,k}(0,1)\right\|^{2}\sim \chi _{k}^{2}}
...
{\displaystyle X_{i}}
 ...
 follows the generalized normal distribution (version 1) with parameters 
...
, then 
{\displaystyle X=(Y-\mu )^{\mathsf {T}}C^{-1}(Y-\mu )}
...
{\displaystyle k\times k}
 ...
 symmetric, idempotent matrix with rank 
{\displaystyle k-n}

, then the quadratic form 
{\displaystyle Y^{\mathsf {T}}\!AY}
...
{\displaystyle w_{i}\geq 0,i=1,\ldots ,p,}
 ...
 then[18]
{\displaystyle {\frac {1}{{\tilde {w}}^{\mathsf {T}}\Sigma {\tilde {w}}}}\sim \chi _{1}^{2}.}

where 
{\displaystyle {\tilde {w}}=(w_{1}/X_{1},\dots ,w_{p}/X_{p})}
...
{\textstyle X=\sum _{i=1}^{n}a_{i}X_{i}}

 is a special case of the generalized chi-squared distribution.
A closed expression for this distribution is not known. It may be, however, approximated efficiently using the property of characteristic functions of chi-square random variables.[21]
...
Gamma, exponential, and related distributions[edit]
The chi-squared distribution 
{\displaystyle X\sim \chi _{k}^{2}}
...
{\textstyle X\sim \Gamma {\left({\tfrac {k}{2}},{\tfrac {1}{2}}\right)}}
...
{\textstyle X\sim \Gamma {\left({\tfrac {k}{2}},2\right)}}
...
{\textstyle X\sim \operatorname {exp} \left({\tfrac {1}{2}}\right)}
...
{\displaystyle X}
 ...
 is Erlang distributed with shape parameter 
{\displaystyle k/2}
...
{\textstyle \sum _{i=1}^{n}\left(X_{i}-{\bar {X}}\right)^{2}\sim \sigma ^{2}\chi _{n-1}^{2}}
...
.
The box below shows some statistics based on 
...
The chi-squared distribution is also often encountered in magnetic resonance imaging.[22]
...
The name "chi-square" ultimately derives from Pearson's shorthand for the exponent in a multivariate normal distribution with the Greek letter Chi, writing −1⁄2χ2 for what would appear in modern notation as −1⁄2xTΣ−1x (Σ being the covariance matrix).[27] The idea of a family of "chi-squared distributions", however, is not due to Pearson but arose as a further development due to Fisher in the 1920s.[25]
